...
import {type DirectoryNode, type FileNode, type FileSystemTree, type SymlinkNode} from '@webcontainer/api';
 ...
 */
const isFileNode = (node: DirectoryNode | FileNode | SymlinkNode): node is FileNode | SymlinkNode =>
...
export class TrainingComponent implements OnInit {
  ...
  private async loadSteps() {
    ...
    const program = JSON.parse(programFiles) as TrainingStepDescription[];
