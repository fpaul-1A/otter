...
describe('new otter application with testing', () => {
  ...
  test('should add testing to existing application', () => {
    packageManagerAdd(`@o3r/testing@${o3rVersion}`, execAppOptions);
    packageManagerExec(`ng add @o3r/testing@${o3rVersion}`, execAppOptions);

    packageManagerExec('ng g @o3r/core:component test-component', execAppOptions);
